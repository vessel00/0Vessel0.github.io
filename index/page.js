        ...
        function (e, n) {
            ...
            var e, n = function () {
                ...
                return O.matches = function (t, e) {
                        ...
                        var o, a, s;
                        return v.test(t) && (o = r(f.createElement(RegExp.$1))), o || (t.replace && (t = t.replace(g, "<$1></$2>")), n === e && (n = m.test(t) && RegExp.$1), n in T || (n = "*"), (s = T[n]).innerHTML = "" + t, o = r.each(l.call(s.childNodes), function () {
                            s.removeChild(this)
                        ...
                        if (!t) return O.Z();
                        if ("string" == typeof t)
                            if ("<" == (t = t.trim())[0] && m.test(t)) i = O.fragment(t, RegExp.$1, n), t = null;
                            else {
                                if (n !== e) return r(n).find(t);
                                i = O.qsa(f, t)
                            }
                        else {
                            if ($(t)) return r(f).ready(t);
                            if (O.isZ(t)) return t;
                            if (D(t)) o = t, i = c.call(o, function (t) {
                                return null != t
                            });
                            else if (M(t)) i = [t], t = null;
                            else if (m.test(t)) i = O.fragment(t.trim(), RegExp.$1, n), t = null;
                            else {
                                if (n !== e) return r(n).find(t);
                                i = O.qsa(f, t)
                            }
                    ...
                    function (t, e) {
                        ...
                        for (; e && (e = e.parentNode);)
                            if (e === t) return !0;
                        return !1
                    }, r.type = L, r.isFunction = $, r.isWindow = F, r.isArray = D, r.isPlainObject = R, r.isEmptyObject = function (t) {
                        var e;
                        for (e in t) return !1;
                        return !0
                        ...
                        css: function (t, e) {
                            ...
                            if ("string" == L(t)) e || 0 === e ? u = z(t) + ":" + H(t, e) : this.each(function () {
                                ...
                                for (n in t) t[n] || 0 === t[n] ? u += z(n) + ":" + H(n, t[n]) + ";" : this.each(function () {
            ...
            return t.Zepto = n, void 0 === t.$ && (t.$ = n),
                ...
                function (e) {
                    ...
                    h.href = t.location.href, e.active = 0, e.ajaxJSONP = function (n, r) {
                        ...
                        }(b), b.crossDomain || ((a = o.createElement("a")).href = b.url, a.href = a.href, b.crossDomain = h.protocol + "//" + h.host != a.protocol + "//" + a.host), b.url || (b.url = t.location.toString()), (g = b.url.indexOf("#")) > -1 && (b.url = b.url.slice(0, g)),
                            function (t) {
                        ...
                        if (E && E.promise(P), b.crossDomain || N("X-Requested-With", "XMLHttpRequest"), N("Accept", S || "*/*"), (S = b.mimeType || S) && (S.indexOf(",") > -1 && (S = S.split(",", 2)[0]), P.overrideMimeType && P.overrideMimeType(S)), (b.contentType || !1 !== b.contentType && b.data && "GET" != b.type.toUpperCase()) && N("Content-Type", b.contentType || "application/x-www-form-urlencoded"), b.headers)
                        ...
                        if (P.open(b.type, b.url, D, b.username, b.password), b.xhrFields)
                            for (r in b.xhrFields) P[r] = b.xhrFields[r];
